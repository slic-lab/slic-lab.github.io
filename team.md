...
<section id="two" class="spotlights">
	...
	<section>
		<a href="team.html" class="image">
			<img src="{% link assets/images/fred.jpg %}" alt="" data-position="center center" />
		</a>
		<div class="content">
			<div class="inner">
				<header class="major">
					<h3>Frédéric Nicolas, BSc</h3>
				</header>
				<p style="color: #ffffff;">MSc student <br> 
				Radiation sciences and biomedical imaging<br> 
				<a href="mailto:Frederic.Nicolas@USherbrooke.ca">Frederic.Nicolas@USherbrooke.ca</a>
				</p>
			</div>
		</div>
	</section>
